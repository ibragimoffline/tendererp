...
// TUGMA.
//
// SOYALAR OLIB TASHLANDI. Avval `shadow-black/20`, `shadow-md` va
// `ring-1 ring-foreground/10` aralash ishlatilardi — uchta boshqa-boshqa
// ko'tarilish darajasi, hech qanday tizimsiz. Zich boshqaruv panelida
